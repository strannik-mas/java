...
public class Program {
	...
	public static void main(String[] args) {
		...
		{
			//для функционала, который не нужен в основном классе (например логику работы с БД)
			Outer.Nested n = new Outer.Nested();	//можно создавать без создания объекта внешнего класса
		}
		{
		...
		}
		{
			...
			//Объект inner класса можно создать только при наличии внешнего класса, привязав его к внешнему
